...
def test_ldap_group_file_maker():
    ...
    try:
        ...
        print_red("--Text in file was not correct. ldap_group_file_maker() did not perform as expected.")
...
def test_ldap_user_file_maker():
    ...
    try:
        ...
        print_red("--Text in file was not correct. ldap_user_file_maker() did not perform as expected.")
